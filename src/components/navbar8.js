  ...
  return (
    <header className="navbar8-container1">
      <header data-thq="thq-navbar" className="navbar8-navbar-interactive">
        <img
          alt={props.logoAlt}
          src="https://mazeymoos.com/unifiedgaming-systems/UnifiedGaming%20Systems.png"
          className="navbar8-image1"
        />
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            <a
              href="https://bsky.app/profile/unifiedgaming-systems.mazeymoos.com"
              target="_blank"
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar8-text23">BlueSky</span>
                </Fragment>
              )}
            </a>
            <a
              href="https://x.com/UnifiedGameSys"
              target="_blank"
              rel="noreferrer noopener"
            ...
            >
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text22">Twitter</span>
                </Fragment>
              )}
            </a>
            <a
              href="https://github.com/UnifiedGaming-Systems"
              target="_blank"
              rel="noreferrer noopener"
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text19">GitHub</span>
                </Fragment>
              )}
            </a>
          </nav>
              ...
              <div className="navbar8-link4-accordion">
                ...
                >
                  <span className="thq-body-small thq-link">
                    {props.link4 ?? (
                      <Fragment>
                        <span className="navbar8-text16">#</span>
                      </Fragment>
                    )}
                  </span>
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text18">Games</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                      ...
                      <div className="navbar8-menu-item4">
                        ...
                        <div className="navbar8-content4">
                          <span className="navbar8-page41 thq-body-large">
                            {props.page4 ?? (
                              <Fragment>
                                <span className="navbar8-text15">Support</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
            ...
            <div className="navbar8-buttons2">
              <button className="thq-button-filled">
                <span>
                  {props.action1 ?? (
                    <Fragment>
                      <span className="navbar8-text26">Main Action</span>
                    </Fragment>
                  )}
                </span>
              </button>
...
Navbar8.defaultProps = {
  page3ImageSrc:
    'https://images.unsplash.com/photo-1526509867162-5b0c0d1b4b33?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMjczNDM5Mnw&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  page4: undefined,
  page4ImageAlt: 'image',
  text: 'Download UnifiedGL',
  linkUrlPage3: 'https://www.teleporthq.io',
  page2ImageAlt: 'image',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1516111143745-fbfc2ebd6352?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMjczNDM5MXw&ixlib=rb-4.0.3&q=80&w=1080',
  link4: undefined,
  ...
  page2ImageSrc:
    'https://images.unsplash.com/photo-1465788786008-f75a725b34e9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMjczNDM5MXw&ixlib=rb-4.0.3&q=80&w=1080',
  link1Url: 'https://www.teleporthq.io',
  link3: undefined,
  action2: undefined,
  page3: undefined,
  link2: undefined,
  logoAlt: 'Gaming Launcher Logo',
  linkUrlPage2: 'https://www.teleporthq.io',
  link1: undefined,
  page2Description: undefined,
  page1Description: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1583241116279-f70432e96c29?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMjczNDM5MXw&ixlib=rb-4.0.3&q=80&w=1080',
  action1: undefined,
}
